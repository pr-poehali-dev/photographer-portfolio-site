        ...
        <div className="container mx-auto">
          <AnimatedSection className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-white/70 text-lg font-light mb-8">
              Свяжитесь со мной, чтобы обсудить ваш будущий проект или задать вопросы.
            </p>
          </AnimatedSection>
        </div>
      </section>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 font-light">
                      <a href="tel:+79001234567" className="hover:text-gold transition-colors">
                        +7 (900) 123-45-67
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 font-light">
                      <a href="mailto:info@photomaster.com" className="hover:text-gold transition-colors">
        ...
        <div className="container mx-auto">
          <AnimatedSection className="text-center mb-8">
            ...
            <p className="text-white/70 max-w-2xl mx-auto mb-8">
              Студия расположена в 5 минутах ходьбы от станции метро "Фотографская"
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection>
            <div className="w-full h-96 bg-black/30 rounded-md overflow-hidden relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <p className="text-white/50">Здесь будет карта. Для внедрения Google Maps или Яндекс.Карт необходимо добавить соответствующий API-ключ.</p>
              </div>
            </div>
          </AnimatedSection>
        </div>
