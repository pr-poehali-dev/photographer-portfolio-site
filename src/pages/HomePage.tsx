...
const galleryCategories = [
  ...
  },
  {
    title: "Природа",
    image:
      "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80",
  ...
  },
  {
    title: "Архитектура",
    image:
      "https://images.unsplash.com/photo-1518005068251-37900150dfca?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80",
...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-dark text-white">
      ...
      <section id="galleries" className="py-16 sm:py-20 px-4 md:px-6">
        <div className="container mx-auto">
          <AnimatedSection className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-playfair mb-3 gold-gradient inline-block">
              Галереи
            </h2>
            <p className="text-white/70 max-w-2xl mx-auto text-sm sm:text-base">
              Исследуйте мои работы по категориям. Каждая фотография
              рассказывает свою историю и передает особую атмосферу момента.
            </p>
          </AnimatedSection>
      ...
      {/* About Section */}
      <section id="about" className="py-16 sm:py-20 px-4 md:px-6 bg-black/30">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <AnimatedSection direction="right" delay={200}>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-playfair mb-4 sm:mb-6 gold-gradient inline-block">
                Обо мне
              </h2>
              <p className="text-white/80 mb-3 sm:mb-4 font-light text-sm sm:text-base">
                Уже более 10 лет я занимаюсь профессиональной фотографией. За
                это время я разработал свой уникальный стиль, который сочетает
                классические техники с современными подходами.
              </p>
              <p className="text-white/80 mb-5 sm:mb-6 font-light text-sm sm:text-base">
                Для меня фотография — это не просто работа, а искусство передачи
                эмоций и историй через визуальные образы. Каждый проект — это
                новый вызов и возможность создать что-то особенное.
              </p>
              <div className="flex flex-wrap gap-4 sm:gap-6 text-center mb-6 sm:mb-8">
                <div className="flex-1">
                  <span className="text-gold text-2xl sm:text-3xl font-playfair">
                    10+
                  </span>
                  <p className="text-white/60 text-xs sm:text-sm">Лет опыта</p>
                </div>
                <div className="flex-1">
                  <span className="text-gold text-2xl sm:text-3xl font-playfair">
                    500+
                ...
                <div className="flex-1">
                  ...
                  <p className="text-white/60 text-xs sm:text-sm">Наград</p>
                </div>
              </div>
              <Button
                asChild
